...
type CommentModel struct {
	...
	MemoryID      int64      `gorm:"column:memory_id;type:integer;not null;index:idx_memory" json:"memory_id"`
	UserID        int64      `gorm:"column:user_id;type:integer;not null;index:idx_user" json:"user_id"`
