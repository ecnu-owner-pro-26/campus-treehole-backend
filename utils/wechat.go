...
// 定义函数类型变量
var GetWechatOpenID func(code string) (*WechatSession, error) = getWechatOpenIDImpl
...
// getWechatOpenIDImpl 调用微信API获取OpenID
func getWechatOpenIDImpl(code string) (*WechatSession, error) {
	// 1. 获取微信配置
